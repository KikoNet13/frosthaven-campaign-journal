...
class SemanticColor(str, Enum):
    ...
    WEEK_TILE_CLOSED_TEXT = _blend(PaletteColor.OXFORD_NAVY.value, NEUTRAL_WHITE, 0.70)
    WEEK_TILE_OPEN_BORDER = _blend(PaletteColor.CERULEAN.value, NEUTRAL_WHITE, 0.30)
    WEEK_TILE_SELECTED_BG = ACCENT_BG
    WEEK_TILE_SELECTED_BORDER = NEUTRAL_WHITE
...
COLOR_TOP_NAV_BUTTON_BORDER = SemanticColor.TOP_NAV_BUTTON_BORDER.value
COLOR_TOP_NAV_BUTTON_TEXT = SemanticColor.TOP_NAV_BUTTON_TEXT.value
COLOR_TOP_NAV_BUTTON_DISABLED_BG = SemanticColor.TOP_NAV_BUTTON_DISABLED_BG.value
COLOR_TOP_NAV_BUTTON_BORDER_DISABLED = SemanticColor.TOP_NAV_BUTTON_BORDER_DISABLED.value
...
COLOR_WEEK_TILE_OPEN_BORDER = SemanticColor.WEEK_TILE_OPEN_BORDER.value
