...
from frosthaven_campaign_journal.ui.app_root_runtime import (
    EntryPanelReadState,
    MainScreenReadState,
)
...
def build_app_root_controller(page: ft.Page) -> ft.Control:
    ...
    def render_shell() -> None:
        ...
        shell_host.content = build_main_shell_view(data=data, actions=actions)
    ...
    def load_entries_for_selected_week() -> None:
        ...
        if not entry_ref_matches_selected_week(local_state, local_state.viewer_entry_ref):
            return
    ...
    def clear_all_write_errors() -> None:
    ...
    def _run_resource_write(action) -> ResourceWriteResult | None:
        ...
        reload_q5 = entry_ref_matches_selected_week(local_state, entry_ref)
...
class AppRootController:
    ...
    def build(self) -> ft.Control:
        return build_app_root_controller(self._page)
